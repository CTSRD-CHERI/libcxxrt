...
unsigned long _Unwind_GetGR (struct _Unwind_Context *e, int i) { return 0; }
void _Unwind_SetGR (struct _Unwind_Context * c, int i, unsigned long l) { }
unsigned long _Unwind_GetIP (struct _Unwind_Context *g) { return 0; }
unsigned long _Unwind_GetIPInfo (struct _Unwind_Context *c, int *i) { return 0; }
void _Unwind_SetIP (struct _Unwind_Context *c, unsigned long l) { }
unsigned long _Unwind_GetLanguageSpecificData (struct _Unwind_Context *c) { return 0; }
unsigned long _Unwind_GetRegionStart (struct _Unwind_Context *c) { return 0; }
